...
//     // function get_track(year, round){
//     //   const data = fetch(`http://127.0.0.1:8000/track/${year}/${round}`).then(res => res.json()).then(data => setTrackData(data));
//     // }  
...
//         <button onClick={() => setShow(!show)}>{show ? "Hide Names" : "Show Names"}</button>

//       {/* Track */}
//       <svg
//         viewBox="-700 -4000 13000 7000"
//         width="100%"
//         height="100%"
