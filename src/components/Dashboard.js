...
//           <div key={racer.driver_id} onClick={onClick} className="flex items-center gap-2 mb-2 bg-black border-[1px] border-white rounded-[10px] p-1 ">
    ...
    <div className="absolute mt-9 bg-transparent p-4 right-0">
      {Object.values(racersData).map(racer => (
        <div 
          ...
          className="flex items-center gap-2 mb-2 bg-black border-[1px] border-white rounded-[10px] p-1"
        >
          <div
            className="h-5 w-5 rounded-full"
            style={{ backgroundColor: racer.color }}
